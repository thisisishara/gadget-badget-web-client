...
public class Funder  extends User{
	...
	public JsonObject readFunders() {
		...
		try
		{
			...
			String query = "SELECT u.user_id, u.username, u.password, u.role_id, u.first_name, u.last_name, u.gender, u.primary_email, u.primary_phone, f.organization FROM `user` u, `funder` f WHERE u.user_id=f.funder_id;";
