...
public class JsonResponseBuilder {
	 ...
	 */
	public JsonObject getJsonArrayResponse(String name, JsonArray jsonArray, OpStatus opStatus, String message) {
		jsonObject = new JsonObject();
		jsonObject.add(name, jsonArray);
		jsonObject.addProperty("STATUS", opStatus.toString());
		jsonObject.addProperty("MESSAGE", message);
		return jsonObject;
	}
